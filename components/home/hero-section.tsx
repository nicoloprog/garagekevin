...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-background">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_oklch(0.75_0.18_55_/_0.08),_transparent_60%)]" />
      <div className="relative mx-auto max-w-7xl px-4 py-24 lg:py-32">
        <div className="max-w-3xl">
          ...
          <h1 className="text-balance font-[family-name:var(--font-heading)] text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-6xl">
            Precision Repair.{" "}
            <span className="text-primary">Premium Parts.</span>
          </h1>
          <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
            From routine maintenance to complex engine work, IronWorks delivers
            expert automotive care backed by quality parts and transparent pricing.
          </p>
