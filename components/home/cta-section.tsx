      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="rounded-xl border border-primary/20 bg-gradient-to-br from-primary/5 to-transparent p-8 text-center sm:p-12">
          ...
          <p className="mx-auto mt-4 max-w-md text-muted-foreground">
            Book online in minutes or give us a call. We offer same-day
            appointments and transparent pricing on all services.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="gap-2 border-border text-foreground">
